                                    ...
                                    <div className="px-6 py-6 lg:px-8">
                                        ...
                                        <form className="space-y-6" action="#">
                                            ...
                                            <div>
                                                ...
                                                <input onChange={handleUploadChange} className="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 file:mr-4 file:py-2 file:px-4 file:border-0 file:text-sm file:font-semibold file:bg-violet-50 file:text-[#019267] hover:file:bg-violet-100" id="file_input" type="file" />
                                            </div>
                                            <button onClick={() => submitHandler()} type="submit" className="w-full text-white bg-[#019267] hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add Animal</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
